...
Next I connected the brown wire to the RS232 side, and a green wire to the TTL-level output and verified that the "A5" was now inverted and level-shifted back to 3.3V.  This is so-called TTL-Serial.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIxNjAwMjE0NywtMTkwMjk5NjgzLDE5MD
